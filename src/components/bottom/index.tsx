...
const Bottom = () => {
  ...
  useEffect(() => {
    ...
    const activeRoute = ListNavigation.find(
  ...
  useEffect(() => {
    if (containerRef.current) {
      const activeIndex = ListNavigation.findIndex(
        (route) => route.route === currentRoute.route
      )
        ...
        >
          <g filter="url(#filter0_f_2021_128)">
            <ellipse
              ...
              rx="34.5"
              ry="7"
              fill="url(#paint0_radial_2021_128)"
            />
          </g>
          <line
            x1="7.25"
            ...
            x2="97.25"
            y2="0.5"
            stroke="url(#paint1_linear_2021_128)"
          />
          <defs>
            <filter
              id="filter0_f_2021_128"
              x="-2.75"
              y="-27"
              width="109"
              height="54"
            ...
            >
              ...
              <feGaussianBlur
                stdDeviation="10"
                result="effect1_foregroundBlur_2021_128"
              />
            </filter>
            <radialGradient
              id="paint0_radial_2021_128"
              cx="0"
              cy="0"
              r="1"
              gradientUnits="userSpaceOnUse"
              gradientTransform="translate(52) rotate(90) scale(7 34.25)"
            >
              <stop offset="0.309974" stopColor="#FFDB6F" />
              <stop offset="1" stopColor="#FFDB6F" stopOpacity="0" />
            </radialGradient>
            <linearGradient
              id="paint1_linear_2021_128"
              x1="7.25"
              y1="1.5"
              x2="97.25"
              y2="1.5"
