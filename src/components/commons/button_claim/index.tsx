...
const ButtonClaim = ({
  ...
  return (
    ...
    >
      ...
      ></div>
      <div
        className={`relative flex  flex-1 select-none   items-center justify-center rounded-xl bg-gray-900 bg-[linear-gradient(140.91deg,#FFF1C4_9.31%,#FEAD1B_83.97%)] px-8 py-4 text-center font-medium transition-all duration-200 focus:outline-none focus:ring-2  focus:ring-gray-900 focus:ring-offset-2 ${className}`}
        onClick={onClick}
      >
